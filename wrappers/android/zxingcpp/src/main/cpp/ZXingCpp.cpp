...
static const char* JavaBarcodeFormatName(BarcodeFormat format)
{
	...
	case BarcodeFormat::AztecRune: return "AZTEC_RUNE";
	case BarcodeFormat::Codabar: return "CODABAR";
	case BarcodeFormat::Code11: return "CODE_11";
	...
	case BarcodeFormat::CodeOne: return "CODE_ONE";
	...
	case BarcodeFormat::DataBarStacked: return "DATA_BAR_STACKED";
	case BarcodeFormat::DataBarStackedOmnidirectional: return "DATA_BAR_STACKED_OMNIDIRECTIONAL";
	case BarcodeFormat::DataBarExpandedStacked: return "DATA_BAR_EXPANDED_STACKED";
	case BarcodeFormat::DataMatrix: return "DATA_MATRIX";
	case BarcodeFormat::DotCode: return "DOT_CODE";
	case BarcodeFormat::GridMatrix: return "GRID_MATRIX";
	case BarcodeFormat::HanXin: return "HAN_XIN";
	...
	case BarcodeFormat::AustraliaPost: return "AUSTRALIA_POST";
	case BarcodeFormat::JapanPost: return "JAPAN_POST";
	case BarcodeFormat::KIXCode: return "KIX_CODE";
	case BarcodeFormat::KoreaPost: return "KOREA_POST";
	case BarcodeFormat::Mailmark: return "MAILMARK";
	case BarcodeFormat::RM4SCC: return "RM4SCC";
	case BarcodeFormat::USPSIMB: return "USPS_IMB";
	case BarcodeFormat::DeutschePostLeitcode: return "DEUTSCHE_POST_LEITCODE";
	case BarcodeFormat::DeutschePostIdentcode: return "DEUTSCHE_POST_IDENTCODE";
	case BarcodeFormat::POSTNET: return "POSTNET";
	case BarcodeFormat::PLANET: return "PLANET";
	case BarcodeFormat::MSI: return "MSI";
	case BarcodeFormat::Telepen: return "TELEPEN";
	case BarcodeFormat::LOGMARS: return "LOGMARS";
	case BarcodeFormat::Code32: return "CODE_32";
	case BarcodeFormat::Pharmacode: return "PHARMACODE";
	case BarcodeFormat::PharmacodeTwoTrack: return "PHARMACODE_TWO_TRACK";
	case BarcodeFormat::PZN: return "PZN";
	case BarcodeFormat::ChannelCode: return "CHANNEL_CODE";
	case BarcodeFormat::Matrix2of5: return "MATRIX_2_OF_5";
	case BarcodeFormat::Industrial2of5: return "INDUSTRIAL_2_OF_5";
	case BarcodeFormat::IATA2of5: return "IATA_2_OF_5";
	case BarcodeFormat::Datalogic2of5: return "DATALOGIC_2_OF_5";
	case BarcodeFormat::CodablockF: return "CODABLOCK_F";
	case BarcodeFormat::Code16K: return "CODE_16K";
	case BarcodeFormat::Code49: return "CODE_49";
	...
	case BarcodeFormat::UPNQR: return "UPN_QR";
