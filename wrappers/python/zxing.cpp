...
PYBIND11_MODULE(zxingcpp, m)
{
	...
	py::enum_<BarcodeFormat>(m, "BarcodeFormat", py::arithmetic{}, "Enumeration of zxing supported barcode formats")
		...
		.value("DataBarStacked", BarcodeFormat::DataBarStacked)
		.value("DataBarStackedOmnidirectional", BarcodeFormat::DataBarStackedOmnidirectional)
		.value("DataBarExpandedStacked", BarcodeFormat::DataBarExpandedStacked)
		.value("DataMatrix", BarcodeFormat::DataMatrix)
		.value("DotCode", BarcodeFormat::DotCode)
		.value("GridMatrix", BarcodeFormat::GridMatrix)
		.value("HanXin", BarcodeFormat::HanXin)
		...
		.value("AustraliaPost", BarcodeFormat::AustraliaPost)
		.value("JapanPost", BarcodeFormat::JapanPost)
		.value("KIXCode", BarcodeFormat::KIXCode)
		.value("KoreaPost", BarcodeFormat::KoreaPost)
		.value("Mailmark", BarcodeFormat::Mailmark)
		.value("RM4SCC", BarcodeFormat::RM4SCC)
		.value("USPSIMB", BarcodeFormat::USPSIMB)
		.value("DeutschePostLeitcode", BarcodeFormat::DeutschePostLeitcode)
		.value("DeutschePostIdentcode", BarcodeFormat::DeutschePostIdentcode)
		.value("POSTNET", BarcodeFormat::POSTNET)
		.value("PLANET", BarcodeFormat::PLANET)
		.value("MSI", BarcodeFormat::MSI)
		.value("Telepen", BarcodeFormat::Telepen)
		.value("LOGMARS", BarcodeFormat::LOGMARS)
		.value("Code32", BarcodeFormat::Code32)
		.value("Pharmacode", BarcodeFormat::Pharmacode)
		.value("PharmacodeTwoTrack", BarcodeFormat::PharmacodeTwoTrack)
		.value("PZN", BarcodeFormat::PZN)
		.value("ChannelCode", BarcodeFormat::ChannelCode)
		.value("Matrix2of5", BarcodeFormat::Matrix2of5)
		.value("Industrial2of5", BarcodeFormat::Industrial2of5)
		.value("IATA2of5", BarcodeFormat::IATA2of5)
		.value("Datalogic2of5", BarcodeFormat::Datalogic2of5)
		.value("CodablockF", BarcodeFormat::CodablockF)
		.value("Code16K", BarcodeFormat::Code16K)
		.value("Code49", BarcodeFormat::Code49)
		...
		.value("UPNQR", BarcodeFormat::UPNQR)
